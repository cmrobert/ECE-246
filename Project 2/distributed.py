...
batch_size = 1 # bath size for training. keep batch_size*num_workers constant for centralized and decentralized cases for a fair comparison
...
def main(): 
    ...
    plt_name = "num_epoch_"+str(num_epochs)+"_batch_size_"+str(batch_size)+"_num_hidden_"+str(num_hidden)+"_lr_"+str(lr)+"_num_nodes_"+str(num_workers)
